//call: 
//root -l 7Li_breakup_1500_MeV_in_GeV.root analyze_g7Li.C

{
  ...
  TCanvas *can = new TCanvas("can","g+7Li->Pi0+Eta+n+6Li",200,10,600,400);
  ...
  for (Int_t i=0; i<nentries;i++) 
  {
   ...
   double px,py,pz;
   TH1F *h1 = new TH1F("h1","Distribution of Fermi Momentum inside Lithium-7",1000,0.,1.);
...
//   PFermiDistributions *f1 = new PFermiDistributions("7Li");
  ...
  can->Print("g7Li_BreakUp.eps");
  can->Print("g7Li_BreakUp.root");
