...
**             The scattering of a photon and a proton  inside 3He                  **
...
void He3_breakup_macro(Int_t EventNumber=10000, Double_t StartEBeam = 1.5, Double_t iter=500./1000.) 
{
  //  PStaticData *mass = new PStaticData();
  char NameFile1[100];
  ...
  {
    // Define projectile (g), target (3He), nucleus fragment (d)
    PParticle *GammaB  = new PParticle("g",EBeam);
    PParticle *Nucleus = new PParticle("3He");
    PParticle *NucRest = new PParticle("d");
    ...
    PParticle *QFtarget = new PParticle("p"); 
    ...
    PParticle *Proton  = new PParticle("p");
    ...
    PParticle *cc3[] = {Delta,Pi0,Proton};
    ...
    sprintf(NameFile1, "3He_breakup_%i_MeV_in_GeV", EBeamMeV); //File name
