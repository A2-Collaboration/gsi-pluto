
{
    ...
    my_reaction2->Print();
    //Create my histogram:
    TH1F * pp_sum2 = new TH1F ("pp_sum","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction3 = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction3->AddBulk(ak);
    my_reaction3->Print();
    //Create my histogram:
    TH1F * pp_sum3 = new TH1F ("pp_sum3","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction2_elastic = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction2_elastic->AddBulk(ak);
    my_reaction2_elastic->Print();
    //Create my histogram:
    TH1F * pp_sum2_elastic = new TH1F ("pp_sum2_elastic","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction3_elastic = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction3_elastic->AddBulk(ak);
    my_reaction3_elastic->Print();
    //Create my histogram:
    TH1F * pp_sum3_elastic = new TH1F ("pp_sum3_elastic","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction2_delta = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction2_delta->AddBulk(ak);
    my_reaction2_delta->Print();
    //Create my histogram:
    TH1F * pp_sum2_delta = new TH1F ("pp_sum2_delta","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction3_delta = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction3_delta->AddBulk(ak);
    my_reaction3_delta->Print();
    //Create my histogram:
    TH1F * pp_sum3_delta = new TH1F ("pp_sum3_delta","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    //Finally PLUTO delta
    PReaction *my_reaction3_pluto = new PReaction("2.5","d","p","n D+ [p dilepton [e+ e-]] (p)");
    my_reaction3_pluto->AddReaction("p D0 [n dilepton [e+ e-]] (p)");
    my_reaction3_pluto->AddBulk(ak);
    TH1F * pp_sum3_pluto = new TH1F ("pp_sum3_pluto","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
    ...
    PReaction *my_reaction2_n1520 = new PReaction("2.5","d","p","p n dilepton [e+ e-] (p)",NULL,1,0,0,0);
    my_reaction2_n1520->AddBulk(ak);
    my_reaction2_n1520->Print();
    //Create my histogram:
    TH1F * pp_sum2_n1520 = new TH1F ("pp_sum2_n1520","pp DiLepton mass (coherent sum)",histo_bins,0.07,histo_max);
