//call: root -l 12C_breakup_1500_MeV_in_GeV.root analyze_g12C.C
...

{
  ...
  TCanvas *can = new TCanvas("can","g+12C->Pi0+Eta+n+11C",200,10,600,400);
  ...
  double px,py,pz;
  TH1F *h1 = new TH1F("h1","Distribution of Fermi Momentum inside Carbon-12",1000,0.,1.);
  ...
  can->Print("g12C_BreakUp.eps");
  can->Print("g12C_BreakUp.root");
