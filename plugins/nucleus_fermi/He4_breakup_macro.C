...
**             The scattering of a photon and a neutron inside 4He                  **
...
void He4_breakup_macro(Int_t EventNumber=10000, Double_t StartEBeam = 1.5, Double_t iter=500./1000.) 
{
  char NameFile1[100];
  ...
  {
    // Define projectile (g), target (4He), nucleus fragment (3He)
    PParticle *GammaB  = new PParticle("g",EBeam);
    PParticle *Nucleus = new PParticle("4He");
    PParticle *NucRest = new PParticle("3He");
    ...
    sprintf(NameFile1, "4He_breakup_%i_MeV_in_GeV", EBeamMeV); //File name
