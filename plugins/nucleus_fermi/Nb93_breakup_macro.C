...
**             The scattering of a photon and a neutron inside 93Nb                 **
...
void Nb93_breakup_macro(Int_t EventNumber=10000, Double_t StartEBeam = 1.5, Double_t iter=500./1000.) 
{
  char NameFile1[100];
  ...
  {
    // Define projectile (g), target (93Nb), nucleus fragment (92Nb)
    PParticle *GammaB  = new PParticle("g",EBeam);
    PParticle *Nucleus = new PParticle("93Nb");
    PParticle *NucRest = new PParticle("92Nb");
    ...
    sprintf(NameFile1, "93Nb_breakup_%i_MeV_in_GeV", EBeamMeV); //File name
