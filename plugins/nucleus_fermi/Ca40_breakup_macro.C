...
**             The scattering of a photon and a neutron inside 40Ca                 **
...
void Ca40_breakup_macro(Int_t EventNumber=10000, Double_t StartEBeam = 1.5, Double_t iter=500./1000.) 
{
  char NameFile1[100];
  ...
  {
    // Define projectile (g), target (40Ca), nucleus fragment (39Ca)
    PParticle *GammaB  = new PParticle("g",EBeam);
    PParticle *Nucleus = new PParticle("40Ca");
    PParticle *NucRest = new PParticle("39Ca");
    ...
    sprintf(NameFile1, "40Ca_breakup_%i_MeV_in_GeV", EBeamMeV); //File name
