{
  ...
  TCanvas *can = new TCanvas("can","g+4He->Pi0+Eta+n+3He",200,10,600,400);
  ...
  double px,py,pz;
  TH1F *h1 = new TH1F("h1","Distribution of Fermi Momentum inside Helium-4",1000,0.,1.);
  ...
  can->Print("g4He_BreakUp.eps");
  can->Print("g4He_BreakUp.root");
